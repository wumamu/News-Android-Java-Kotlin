...
//        int width = size.x;
//        int height = size.y;
//        Log.i("display-size", "display-width:" + width);
//        Log.i("display-size", "display-height:" + height);
//        DisplayMetrics outMetrics = new DisplayMetrics();
//        display.getMetrics(outMetrics);
//        float density = getResources().getDisplayMetrics().density;
//        float dpHeight = outMetrics.heightPixels / density;
//        float dpWidth = outMetrics.widthPixels / density;
//        Log.i("display-size", "display-width in dp:" + dpWidth);
//        Log.i("display-size", "display-height in dp:" + dpHeight);
//        // textview generate #######################################################################
...
//                    Arrays.fill(count, 0);
//                    Log.i("MyScrollView", "Start");
//                    while(!activityEnd)
//                    {
//                        if (activityStopped && !activityEnd)
//                        {
//                            Log.i("MyScrollView", "Stop");
//                            for (int i = 0; i < N; i++)
//                            {
//                                Log.i("MyScrollView", i + " count: " + count[i]/10);
//                            }
//                            Log.i("MyScrollView",  "time_on_page: " + count_running/10);
//                            while (activityStopped)
//                            {
//                                Thread.sleep(100);
//                            }
//                            Log.i("MyScrollView", "Restart");
//                        }
...
////                        Log.i("position", "moving: (" + motionEvent.getX() + ", " + motionEvent.getY() + ")");
//                        return true;
//                    case MotionEvent.ACTION_DOWN:
//                        Log.i("on touch", "touched down");
//                        Log.i("on touch", "moving: (" +  motionEvent.getXPrecision()*motionEvent.getX() + ", " + motionEvent.getY() + ")");
//                        return true;
//                    case MotionEvent.ACTION_UP:
//                        Log.i("on touch", "touched up");
//                        Log.i("on touch", "moving: (" + motionEvent.getX() + ", " + motionEvent.getY() + ")");
//                        return true;
//                }
//                Log.i("on touch", "pressure: " + motionEvent.getPressure());
//                return false;
//            }
//        });
//

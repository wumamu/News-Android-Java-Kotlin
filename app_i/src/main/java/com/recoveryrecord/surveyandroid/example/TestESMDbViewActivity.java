...
public class TestESMDbViewActivity extends AppCompatActivity {
    Intent intent;
    @Override
    ...
    public void onBackPressed() {
        intent = new Intent(TestESMDbViewActivity.this, TestESMJsonViewActivity.class);

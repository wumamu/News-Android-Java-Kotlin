...
public class AppUsage {
    ...
    public AppUsage(){
        ...
        this.KEY_APPUSAGE = "NA";
        this.KEY_USER_ID = "NA";
    }
    public AppUsage(String KEY_DOC_ID,
                               long KEY_TIMESTAMP,
        ...
        this.KEY_APPUSAGE = KEY_APPUSAGE;
    }
    ...
    public String getKEY_APPUSAGE(){
        return KEY_APPUSAGE;
    }

    public void setKEY_APPUSAGE(String KEY_APPUSAGE){
